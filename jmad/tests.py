...
class StudentTestCase(LiveServerTestCase):
    def setUp(self):
        ...
        #.implicitly_wait(self,time_to_wait=10)
        #self.browser.implicitly_wait(self.browser,time_to_wait=10)
    ...
    def test_student_find_solos(self):
       ...
       # instrument_input.submit()
        ...
        search_results = self.browser.find_element_by_css_selector('.jmad-search-result')
